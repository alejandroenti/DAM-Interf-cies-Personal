...
public class ControllerDesktop implements Initializable {
    ...
    private String[] properties_consoles = {"name", "date", "procesador", "color", "units_sold", "image"};
    private String[] properties_videogames = {"name", "year", "type", "plot", "image"};
    private String[] properties_characters = {"name", "image", "color", "game"};
